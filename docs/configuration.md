...
You can get Imposter to create configuration files for you, based on an [existing endpoint](./proxy_endpoint.md), [OpenAPI specification or WSDL file](./scaffold.md). If you don't have any of these, it's easy to create the configuration using the following instructions. 
